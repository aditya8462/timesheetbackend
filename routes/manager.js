...
router.post("/displayprojecttimesheet", function (req, res) {
  pool.query(
    "select *,T.status as tstatus from timesheet T,assignproject AP,employee E where T.employeeid=AP.employeeid and T.employeeid=E.employeeid and E.manager=? and T.projectid=? group by T.timesheetid",
